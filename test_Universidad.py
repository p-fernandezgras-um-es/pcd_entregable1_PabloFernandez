...
class Universidad:
    ...
    def añadir_estudiante(self,nombre,DNI,direccion,sexo,grado,asignaturas):
        self.estudiantess.append(Estudiante(nombre,DNI,direccion,sexo,grado,asignaturas))
...
def test_aprobar_asignatura():
    Uni=Universidad([],[])
    Uni.añadir_estudiante(nombre="Juan Pérez Calatraba",
                    DNI="799568L",
    ...
    Uni.aprobar_asignatura("799568L",Asignaturas_ADE.CONTABILIDAD_FINANCIERA)
    assert Uni.asignaturas_estudiantes("799568L")==[Asignaturas_ADE.ETICA_EMPRESARIAL,Asignaturas_ADE.FINANZAS]

def test_cambiar_departamento():
    Uni=Universidad([],[])
    Uni.añadir_profesor_titular(nombre="Enrique Cueto Delgado",
                        DNI="12345678A",
    ...
    Uni.cambiar_departamento("12345678A",Departamentos.DITEC)
    assert Uni.departamento_md("12345678A")==Departamentos.DITEC

def test_cambiar_area_investigacion():
    Uni=Universidad([],[])
    Uni.añadir_profesor_titular(nombre="Enrique Cueto Delgado",
                        DNI="12345678A",
                        direccion="c/Sendero de la Aurora",
                        ...
                        area_investigacion="Ingeniería y Tecnología",
                        asignaturas=[Asignaturas_Arquitectura.INSTALACIONES_ARQUITECTONICAS,Asignaturas_IngIndus.INGENIERIA_DE_MATERIALES])
    Uni.cambiar_area_investigacion("12345678A","area")
    assert Uni.area_investigacion_md("12345678A")=="area"
